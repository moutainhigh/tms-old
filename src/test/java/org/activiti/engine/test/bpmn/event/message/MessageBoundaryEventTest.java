...
public class MessageBoundaryEventTest extends PluggableActivitiTestCase {
	...
	public void testDoubleBoundaryMessageEvent() {
		...
		Execution execution1 = runtimeService.createExecutionQuery().messageEventSubscriptionName("messageName_1")
				.singleResult();
		assertNotNull(execution1);

		Execution execution2 = runtimeService.createExecutionQuery().messageEventSubscriptionName("messageName_2")
				.singleResult();
	...
	public void testBoundaryMessageEventOnSubprocessAndInsideSubprocess() {
		...
		Execution execution2 = runtimeService.createExecutionQuery().messageEventSubscriptionName("messageName2")
				.singleResult();
		assertNotNull(execution2);
	...
	public void testBoundaryMessageEventOnSubprocess() {
		...
		executionMessageOne = runtimeService.createExecutionQuery().messageEventSubscriptionName("messageName_one")
				.singleResult();
		assertNull(executionMessageOne);

		executionMessageTwo = runtimeService.createExecutionQuery().messageEventSubscriptionName("messageName_two")
				.singleResult();
	...
	public void testBoundaryMessageEventOnSubprocessAndInsideSubprocessMultiInstance() {
		...
		List<Execution> executions = runtimeService.createExecutionQuery().messageEventSubscriptionName("messageName")
				.list();
