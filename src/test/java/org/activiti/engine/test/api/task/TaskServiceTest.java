...
public class TaskServiceTest extends PluggableActivitiTestCase {
	...
	public void testCustomTaskComments() {
		if(processEngineConfiguration.getHistoryLevel().isAtLeast(HistoryLevel.ACTIVITY)) {
			...
			Comment customComment1 = taskService.addComment(taskId, null, customType1,
			...
			Comment customComment3 = taskService.addComment(taskId, null, customType2,
	...
	public void testGetVariableLocalWithInvalidCast() {
		...
		// catchException(taskService).getVariableLocal(currentTask.getId(),
		// "variable1", Boolean.class);
		//
	...
	public void testGetVariableWithInvalidCast() {
		...
		// catchException(taskService).getVariable(currentTask.getId(),
		// "variable1", Boolean.class);
		//
		// Exception e = caughtException();
		// assertNotNull(e);
