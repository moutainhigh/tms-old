...
public class Formula_getcolnmvTest extends AbstractFormulaTestCase {
	@Test
	public void test1() {
		String[] formulas = { "b->getColNmv(sm_user,pk_corp,cuserid,cuserid)" };
	...
	@Test
	public void test2() {
		String[] formulas = { "b->getColNmv(sm_user,pk_corp,cuserid,cuserid,__nocache);c->getColNmv(sm_user,pk_corp,cuserid,cuserid,__nocache);" };
