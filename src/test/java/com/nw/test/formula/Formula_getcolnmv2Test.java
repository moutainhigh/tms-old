...
public class Formula_getcolnmv2Test extends AbstractFormulaTestCase {
	@Test
	public void test1() {

		String[] formulas = { "b->getColNmv2(sm_user,pk_corp,cuserid,cuserid,dr,dr)" };
	...
	@Test
	public void test2() {
		String[] formulas = { "b->getColNmv2(sm_user,pk_corp,cuserid,cuserid,dr,dr,__nocache);c->getColNmv2(sm_user,pk_corp,cuserid,cuserid,dr,dr,__nocache);" };
