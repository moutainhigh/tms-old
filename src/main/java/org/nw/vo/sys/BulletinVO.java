 ...
 */
public class BulletinVO extends SuperVO {
	...
	public String getPk_bulletin() {
		return pk_bulletin;
	}

	public void setPk_bulletin(String pk_bulletin) {
		this.pk_bulletin = pk_bulletin;
	}
