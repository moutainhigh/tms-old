...
/**
 * 业务异常类。对违反业务逻辑的操作抛出这个异常。这属于EJB规范 中的应用级异常。<br>
 * 这类异常应由操作员判断如何处理，因此BO类不应捕获这类异常，而 应直接将它们转发给客户端。<br>
 * 注意：对BO类中抛出业务异常的方法，应在该BO对象的remote接口中 对应方法的声明上加上对该异常的声明。
 * 
