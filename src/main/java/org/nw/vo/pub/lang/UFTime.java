...
public final class UFTime implements java.io.Serializable, Comparable {
	...
	/**
	 * 以从1970年1月1日0时0分0秒到现在的毫秒数来构造时间 创建日期：(00-7-10 14:37:17)
	 * 
	 * @param m
	 *            long
	 */
	...
	/**
	 * /////////////////////////////////////////////////////////
	 * 功能说明：用java.sql.Date类型构造UF时间类型 参数说明： 返回值： 已知错误：（可选） 抛出异常：（可选） 更改的对象属性：（可选）
	 * 更改历史：（可选） 使用范例：（可选） 状态变迁：（可选） 并发问题：（可选）
	 * /////////////////////////////////////////////////////////
	 * 
	 * @param date
	 *            java.sql.Date
	...
	/**
	 * /////////////////////////////////////////////////////////
	 * 功能说明：用java.util.Date类型构造时间类型 参数说明： 返回值： 已知错误：（可选） 抛出异常：（可选） 更改的对象属性：（可选）
	 * 更改历史：（可选） 使用范例：（可选） 状态变迁：（可选） 并发问题：（可选）
	 * /////////////////////////////////////////////////////////
	 * 
	 * @param date
	...
	/**
	 * 返回时间先后，不考虑日期： 大于0为参数之后时间 等于0和参数为同一时刻 小于0为参数之前时间
	 */
	...
	/**
	 * 如果字符串的时间能转换成有效时间串－－－转换。 创建日期：(2001-5-28 13:28:29)
	 * 
	 * @return java.lang.String
	 * @param sTime
	 *            java.lang.String
	...
	/**
	 * 以从1970年1月1日0时0分0秒到现在的毫秒数来构造时间 参数o无意义，只是为了表示一个新的构造 创建日期：(00-7-10 14:37:17)
	 * 
	 * @param m
	 *            long
	 */
	...
	/**
	 * 此处插入方法说明。 创建日期：(2001-9-18 10:54:22)
	 * 
	 * @param strTime
	 *            java.lang.String
	 * @param isParse
