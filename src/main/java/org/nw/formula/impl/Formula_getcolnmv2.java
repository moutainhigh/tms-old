...
/**
 * getColNmv2(tablename,fieldname,pkfield1,pkvalue1,pkfield2,pkvalue2)
 * 根据主键从数据库查询特定字段的值,其返回的值将直接作为数字使用。 其功能类似SQL语句:select fieldname from tablename
 * where pkfield1 = pkvalue1 and pkfield2 = pkvalue2. 从这条SQL语句可以看出各个参数的含义.
 * 
 * @author fangw
 */
public class Formula_getcolnmv2 extends AbstractFormula {
