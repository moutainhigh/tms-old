...
/**
 * getColValue公式
 * 格式示例：pk_billtype_name->getColValue(bd_billtype,billtypename,pk_billtypecode,
 * pk_billtype)
 * 
 * @author fangw
 */
public class Formula_getcolvalue extends AbstractFormula {
	...
	public Object getResult(Map<String, Object> rowContext) {
		...
		try {
			if(argList.get(3) == null) {
				...
				logger.debug("公式参数=" + argList.get(3));
