 ...
 * 
 */
public class ExpAccidentReasonTypeMultiSelectModel implements IMultiSelect {
	...
	public String getConsult_code() {
		...
		AggregatedValueObject aggVO = service.getAggVOByDatatypeCode("exp_accident_reason_type");
		if(aggVO != null) {
