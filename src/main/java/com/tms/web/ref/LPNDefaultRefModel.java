 ...
 */
@Controller
@RequestMapping(value = "/ref/common/lpn")
public class LPNDefaultRefModel extends AbstractGridRefModel {
	...
	protected String[] getFieldCode() {
		return new String[] { LpnVO.LPN, LpnVO.LPN_TYPE, LpnVO.MEMO };
	}

	protected String[] getFieldName() {
		return new String[] { "LPN", "LPN类型", "备注" };
	}

	public Map<String, Object> load4Grid(HttpServletRequest request) {
		String condition = getGridQueryCondition(request, LpnVO.class);
		...
		PaginationVO page = baseRefService.queryForPagination(LpnVO.class, offset, pageSize, cond.toString());
	...
	public Map<String, Object> getByCode(String code) {
		return this.genAjaxResponse(true, null,
				baseRefService.getVOByCode(LpnVO.class, code, " isnull(locked_flag,'N')='N'"));
	}

	public Map<String, Object> getByPk(String pk) {
		return this.genAjaxResponse(true, null, baseRefService.getVOByPk(LpnVO.class, pk));
	}
