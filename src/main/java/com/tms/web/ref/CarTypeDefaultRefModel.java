 ...
 */
@Controller
@RequestMapping(value = "/ref/common/cartype")
public class CarTypeDefaultRefModel extends AbstractGridRefModel {
	...
	protected String[] getFieldCode() {
		return new String[] { CarTypeVO.CODE, CarTypeVO.NAME, CarTypeVO.MEMO };
	}

	protected String[] getFieldName() {
		return new String[] { "类型编码", "类型名称", "备注" };
	}

	public Map<String, Object> load4Grid(HttpServletRequest request) {
		String condition = getGridQueryCondition(request, CarTypeVO.class);
		...
		PaginationVO page = baseRefService.queryForPagination(CarTypeVO.class, offset, pageSize, cond.toString());
		return this.genAjaxResponse(true, null, page);
	}

	public String getPkFieldCode() {
		return CarTypeVO.PK_CAR_TYPE;
	}
	...
	public String getNameFieldCode() {
		return CarTypeVO.NAME;
	}

	public Map<String, Object> getByCode(String code) {
		return this.genAjaxResponse(true, null,
				baseRefService.getVOByCode(CarTypeVO.class, code, " isnull(locked_flag,'N')='N'"));
	}

	public Map<String, Object> getByPk(String pk) {
		return this.genAjaxResponse(true, null, baseRefService.getVOByPk(CarTypeVO.class, pk));
	}
