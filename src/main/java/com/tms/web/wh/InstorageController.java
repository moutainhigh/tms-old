...
import com.tms.service.wh.InstorageService;
 ...
 */
@Controller
@RequestMapping(value = "/wh/instorage")
public class InstorageController extends AbsBillController {

	@Autowired
	private InstorageService instorageService;

	public InstorageService getService() {
