...
public class RepairVO extends SuperVO {
	...
	private UFDateTime repair_time;
	private UFDouble repair_mileage;
	...
	public UFDateTime getRepair_time() {
		return repair_time;
	}

	public void setRepair_time(UFDateTime repair_time) {
		this.repair_time = repair_time;
	}

	public UFDouble getRepair_mileage() {
		return repair_mileage;
	}

	public void setRepair_mileage(UFDouble repair_mileage) {
		this.repair_mileage = repair_mileage;
	}
