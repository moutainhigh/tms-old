...
//yaojiie 2015 12 16 保养管理VO
@SuppressWarnings("serial")
public class MaintainVO extends SuperVO {
	
	private String pk_maintain	;
	private String vbillno;
	private Integer vbillstatus;
	private String carno;
	private String pk_driver;
	
	private Integer factory_type;
	private String pk_address;
	
	private UFDateTime maintain_time;
	private UFDateTime next_maintain_time;
	private UFDouble maintain_mileage;
	private UFDouble next_maintain_mileage;
	...
	public void setFactory_type(Integer factory_type) {
	...
	public UFDateTime getMaintain_time() {
		return maintain_time;
	}

	public void setMaintain_time(UFDateTime maintain_time) {
		this.maintain_time = maintain_time;
	}

	public UFDateTime getNext_maintain_time() {
		return next_maintain_time;
	}

	public void setNext_maintain_time(UFDateTime next_maintain_time) {
		this.next_maintain_time = next_maintain_time;
	}

	public UFDouble getMaintain_mileage() {
		return maintain_mileage;
	}

	public void setMaintain_mileage(UFDouble maintain_mileage) {
		this.maintain_mileage = maintain_mileage;
	}

	public UFDouble getNext_maintain_mileage() {
		return next_maintain_mileage;
	}

	public void setNext_maintain_mileage(UFDouble next_maintain_mileage) {
		this.next_maintain_mileage = next_maintain_mileage;
	}
	...
	public static String getPkMaintain() {
		return PK_MAINTAIN;
	}
