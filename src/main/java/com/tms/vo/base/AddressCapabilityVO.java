...
//yaojiie  2015 11 17 添加地址能力VO
@SuppressWarnings("serial")
public class AddressCapabilityVO extends SuperVO {
	
	private String pk_address_capability;
	...
	public static final String PK_ADDRESS_CAPABILITY = "pk_address_capability";
	public static final String PK_ADDRESS = "pk_address";
	

	public String getPk_address_capability() {
		return pk_address_capability;
	}

	public void setPk_address_capability(String pk_address_capability) {
		this.pk_address_capability = pk_address_capability;
	}
	...
	public static String getPkAddressCapability() {
		return PK_ADDRESS_CAPABILITY;
	}
