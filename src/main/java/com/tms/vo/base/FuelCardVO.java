...
public class FuelCardVO extends SuperVO {
	
	private String pk_fuelcard;
	private String fuelcard_code;
	private String fuelcard_name;
	...
	public static final String FUELCARD_CODE = "fuelcard_code";
	public static final String FUELCARD_NAME = "fuelcard_name";
	...
	public String getFuelcard_code() {
		return fuelcard_code;
	}

	public void setFuelcard_code(String fuelcard_code) {
		this.fuelcard_code = fuelcard_code;
	}

	public String getFuelcard_name() {
		return fuelcard_name;
	}

	public void setFuelcard_name(String fuelcard_name) {
		this.fuelcard_name = fuelcard_name;
	}
