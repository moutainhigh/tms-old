...
public class ExAggMergeRuleVO extends HYBillVO implements IExAggVO {

	public static final String TS_MERGE_RULE_B = "ts_merge_rule_b";
	...
	public String[] getTableCodes() {
		...
		return new String[] { TS_MERGE_RULE_B };
