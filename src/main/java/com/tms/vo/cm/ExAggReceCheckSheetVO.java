...
public class ExAggReceCheckSheetVO extends HYBillVO implements IExAggVO {

	// ����װ�ض��ӱ���ݵ�HashMap
	private HashMap hmChildVOs = new HashMap();

	/**
	 * ���ض���ӱ�ı��� �����뵥��ģ���ҳǩ�����Ӧ �������ڣ�2013-03-23 18:52:53
	 * 
	 * @return String[]
	 */
	public String[] getTableCodes() {

		return new String[] { "ts_rece_check_sheet_b" };

	}

	/**
	 * ���ض���ӱ��������� �������ڣ�2013-03-23 18:52:53
	 * 
	 * @return String[]
	 */
	...
	/**
	 * Ϊ�ض��ӱ�����VO��� �������ڣ�2013-03-23 18:52:53
	 * 
	 * @param String
	 *            tableCode
