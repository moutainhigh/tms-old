...
public class RfTempBVO extends SuperVO {
	
	private String pk_rf_temp_b;
	private String pk_entrust;
	private String pk_ent_line_b;
	private String pk_address;
	private String lot;
	private UFBoolean if_exp;
	...
	public String getPk_rf_temp_b() {
		return pk_rf_temp_b;
	}

	public void setPk_rf_temp_b(String pk_rf_temp_b) {
		this.pk_rf_temp_b = pk_rf_temp_b;
	}
	...
	public UFBoolean getIf_exp() {
		return if_exp;
	}

	public void setIf_exp(UFBoolean if_exp) {
		this.if_exp = if_exp;
	}
