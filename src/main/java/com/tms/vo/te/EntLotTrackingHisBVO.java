...
public class EntLotTrackingHisBVO extends SuperVO {
	private String pk_ent_lot_track_his_b;
	private String lot;
	...
	public String getPk_ent_lot_track_his_b() {
		return pk_ent_lot_track_his_b;
	}
	public void setPk_ent_lot_track_his_b(String pk_ent_lot_track_his_b) {
		this.pk_ent_lot_track_his_b = pk_ent_lot_track_his_b;
	}
