 ...
 * @since 1.0
 */
public class InstorageBVO extends org.nw.vo.pub.SuperVO {
	private static final long serialVersionUID = 1L;

	private java.lang.String pk_instorage_b;

	private java.lang.Integer dr;

	private org.nw.vo.pub.lang.UFDateTime ts;

	private java.lang.String pk_instorage;
	...
	private UFDouble accepted_count;

	private UFDouble located_count;
	...
	// 扩展字段，数据库没有，当前输入的要接收的数量
	private UFDouble accept_count;

	public static final String PK_INSTORAGE_B = "pk_instorage_b";
	public static final String DR = "dr";
	public static final String TS = "ts";
	public static final String PK_INSTORAGE = "pk_instorage";
	...
	public static final String LOCATED_COUNT = "located_count";
	...
	public java.lang.String getPk_instorage_b() {
		return this.pk_instorage_b;
	}

	public void setPk_instorage_b(java.lang.String value) {
		this.pk_instorage_b = value;
	}

	public UFDouble getAccepted_count() {
		return accepted_count;
	}

	public void setAccepted_count(UFDouble accepted_count) {
	...
	public java.lang.String getPk_instorage() {
		return this.pk_instorage;
	}

	public void setPk_instorage(java.lang.String value) {
		this.pk_instorage = value;
	}
	...
	public UFDouble getAccept_count() {
		return accept_count;
	}

	public void setAccept_count(UFDouble accept_count) {
		this.accept_count = accept_count;
	}

	public UFDouble getLocated_count() {
		return located_count;
	}

	public void setLocated_count(UFDouble located_count) {
		this.located_count = located_count;
	}
	...
	public String getPKFieldName() {
		return "pk_instorage_b";
	}

	public String getTableName() {
		return "TS_INSTORAGE_B";
	}
}
