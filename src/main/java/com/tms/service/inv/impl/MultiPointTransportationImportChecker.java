 ...
 * @date 2016 11 14
 */
public class MultiPointTransportationImportChecker implements ImportChecker {
...
//		if(fieldVO.getItemkey().equals("low_temp")) {
//			if(value == null) {
//				throw new BusiException("第[?]行的最低温度不存在！",rowNum+"");
//			}
//		}
//		if(fieldVO.getItemkey().equals("hight_temp")) {
//			if(value == null) {
//				throw new BusiException("第[?]行的最高温度不存在！",rowNum+"");
//			}
//		}
		if(value != null) {
