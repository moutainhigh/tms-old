...
KindEditor.plugin('image', function(K) {
	var self = this, name = 'image',
		...
		//此处basePath是kindeditor.js所在的目录
		var contextPath = self.basePath.substring(0,self.basePath.length-1);
		contextPath = contextPath.substring(0,contextPath.lastIndexOf("/"));
		var uploadJson = K.undef(self.uploadJson, contextPath + '/editor/uploadImage.do');
		var imgPath = self.basePath + 'plugins/image/images/';
