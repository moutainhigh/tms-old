        ...
        for(var j = 0, len = rs.length; j < len; j++){
            ...
            for(var i = 0; i < colCount; i++){
                ...
                if(c.scope && c.scope.beforeRenderer){
	            	c.scope.beforeRenderer.call(c.scope, r.data[c.name], p, r, rowIndex, i, ds);
	            }
...
//                }
    ...
    getColumnData : function(){
        ...
        for(var i = 0; i < colCount; i++){
            ...
            cs[i] = {
                ...
                //FIXME
                beforeRenderer : cm.beforeRenderer,
    ...
    updateLockedWidth: function(){
        ...
        this.mainWrap.dom.style.left = (lw + lp + rp-2) + 'px';//XXX 2014-09-29 扣除2个像素，让lock和unlock的线合在一起
        if(this.innerHd){
