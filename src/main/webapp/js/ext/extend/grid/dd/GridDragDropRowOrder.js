    ...
    onGridRender : function (grid){
        ...
        this.target = new Ext.dd.DropTarget(grid.getEl(),{
            ...
            notifyDrop: function(dd, e, data){
                ...
                if (this.gridDropTarget.fireEvent(self.copy ? 'beforerowcopy' : 'beforerowmove', this.gridDropTarget, data.rowIndex, rindex, data.selections) === false){
                    return false;
                }
                ...
                */
                ...
                for (var i = selections.length - 1; i >= 0; i--){
                    ...
                    //FIXME XUQC 2013-7-29 这条记录已经在modified中了，调用insert又会重新加入，这里移除一条
                    ds.modified.remove(selections[i]);
                }
