 ...
 * 显示身份证的field
 * 
 * @class uft.extend.form.IdentityField
 * @extends Ext.form.DisplayField
 */
uft.extend.form.IdentityField = Ext.extend(Ext.form.DisplayField, {
	//这个高度和宽度与缩略图的高度和宽度一致
	defaultAutoCreate : {tag: 'img', src: Ext.BLANK_IMAGE_URL,width : 102, height:126,style:'cursor:pointer;'},
	...
	constructor : function(config) {
		...
		uft.extend.form.IdentityField.superclass.constructor.call(this);
	},
	onRender : function(ct, position){
		uft.extend.form.IdentityField.superclass.onRender.call(this,ct,position);
		this.bindListeners();
	},
...
Ext.reg("identityField",uft.extend.form.IdentityField);