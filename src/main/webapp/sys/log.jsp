...
<html>
	...
	<nw:Bill templetVO="${templetVO}" headerGridPageSize="20" headerGridImmediatelyLoad="true" isBuildHeaderCard="false" headerGridCheckboxSelectionModel="true" headerGridSingleSelect="false" />
	</body>
