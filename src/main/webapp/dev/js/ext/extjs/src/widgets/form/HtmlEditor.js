...
Ext.form.HtmlEditor = Ext.extend(Ext.form.Field, {
    ...
    /**
     * 
     * @type String 连接的标题，默认是选中的text
     */
    createLinkTitle : 'Please enter the title for the link:',
    /**
    ...
    createToolbar : function(editor){
        ...
        var tb = new Ext.Toolbar({
            ...
            //FIXME 默认是hidden的，不需要显示，当设置readOnly=false时显示
//            hidden : true,
            items: items
        });
    ...
    setReadOnly: function(readOnly){
        ...
        //FIXME XUQC 加入readOnly的样式,如果是readonly为true，则不显示toolbar，否则显示
        //这里会影响到辅助工具栏
        if(this.readOnly){
//        	if(this.tb){
//        		this.tb.hide();
...
//        	}
    ...
    createLink : function() {
        ...
        if(url && url != 'http:/'+'/'){
            if(this.linksInNewWindow !== false){//FIXME 2012-10-26 默认是在新窗口打开
