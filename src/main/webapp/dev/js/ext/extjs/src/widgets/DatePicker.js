...
Ext.DatePicker = Ext.extend(Ext.BoxComponent, {
    ...
    onRender : function(container, position){
        ...
        m.push('</tr></tbody></table></td></tr>',
                this.showToday ? '<tr><td class="x-date-bottom-1 x-date-bottom"></td><td class="x-date-bottom-2 x-date-bottom" align="right"></td><td class="x-date-bottom-3 x-date-bottom" align="right"></td></tr>' : '',
        ...
        //FIXME 2013-1-22增加清空按钮
        this.clearBtn = new Ext.Button({
            renderTo: this.el.child('td.x-date-bottom-1', true),
            text: '清空',
            handler: this.clearSelect,
            scope: this
        });   
        if(this.showToday){
            ...
            this.todayBtn = new Ext.Button({
                renderTo: this.el.child('td.x-date-bottom-2', true),
        ...
        this.okBtn = new Ext.Button({
            renderTo: this.el.child('td.x-date-bottom-3', true),
            text: this.okText,
            handler: this.okSelect,
            scope: this
        });        
    ...
    okSelect : function(){
        if(!this.disabled){
        	var el = this.el.child('td.x-date-selected a');
        	if(el){
        		this.setValue(new Date(el.dom.dateValue));
        		this.fireEvent('select', this, this.value);
        	}
        }
    },
