...
<html>
	...
	<script type="text/javascript">
		MyToolbar = Ext.extend(uft.jf.BillToolbar, {
			getBtnArray : function(){
				...
				btns.push(new uft.extend.Button({
					...
					enabledBizStatus : [uft.jf.bizStatus.NEW,uft.jf.bizStatus.INSTO_PART_REC,uft.jf.bizStatus.INSTO_ALL_REC,uft.jf.bizStatus.INSTO_ADDED]
				}));
		...
		function updateHeaderSummary(){
			var resultMap = uft.Utils.getGridSumValueMap('ts_instorage_b',['order_count','weight','volume'])
		...
		function afterEditGoods_code(record){
			var pk_goods = uft.Utils.getColumnValue(record,'pk_goods');
			var grid = Ext.getCmp('ts_instorage_b');
			if(grid){
