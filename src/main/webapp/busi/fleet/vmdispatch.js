Ext.ns('uft.vm');
uft.vm.vmdispatch = function(config){
	...
	this.formPanel = new uft.extend.form.FormPanel({
		...
		items : [{
				...
				items : [{
					...
					newlineflag : true,
					colspan : 1
				},{"refName":"地址档案-web","itemCls":"uft-form-label-not-null","xtype":"headerreffield","name":"addr","fieldLabel":"出车地址",allowBlank : false,editable:true, 
	...
	uft.vm.vmdispatch.superclass.constructor.call(this, {
		title : '出车',
		width : 500,
		height : 300,
		collapsible : false,
...
Ext.extend(uft.vm.vmdispatch,Ext.Window, {
	saveAction : function(){
