Ext.ns('uft.cm');
uft.cm.uploadPDAttachment = function(config){
	...
	var uploadUrl = ctxPath+'/attach/attach/uploadAttachment.do?pk_pay_detail='+this.record.data['pk_pay_detail']+'&funCode=t4033';
	...
	uft.cm.uploadPDAttachment.superclass.constructor.call(this, {
		title : '附件管理',
		width : 800,
		height : 500,
		collapsible : false,
...
Ext.extend(uft.cm.uploadPDAttachment,Ext.Window, {
});
