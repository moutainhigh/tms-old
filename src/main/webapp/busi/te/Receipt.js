...
/**
 */
uft.te.Receipt = function(config){
	...
	uft.te.Receipt.superclass.constructor.call(this, {
		title : '回单',
		width : 500,
		height : 300,
		collapsible : false,
...
Ext.extend(uft.te.Receipt,Ext.Window, {
	saveAction : function(){
		...
		for(var i=0;i<this.records.length;i++){
			vbillnos.push(this.records[i].data['vbillno']);
		}
