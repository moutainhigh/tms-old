...
/**
 * 异常跟踪-点击车牌号，显示当前车辆的位置
 * @class uft.te.Tracking
 * @extends Ext.Window
 */
uft.te.CurrentTracking = Ext.extend(Ext.Window, {
	...
	constructor : function(config) {
		...
		uft.te.CurrentTracking.superclass.constructor.call(this, {
			id : 'CurrentTracking',
			title : '车辆|司机跟踪',
			width : 900,
			height : 500,
	...
	doTrack : function(){
		...
		uft.Utils.doAjax({
	    	scope : this,
	    	params : {pk_entrust:this.pk_entrust,carno:this.carno,pk_driver:this.pk_driver},
	    	url : ctxPath + '/te/tracking/getCurrentTracking.json',
	    	isTip : false,
	    	mask : false,
	...
	afterRender : function(){
		uft.te.CurrentTracking.superclass.afterRender.call(this);
		//创建地图
