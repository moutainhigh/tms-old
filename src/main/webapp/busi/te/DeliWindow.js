...
/**
 */
uft.te.DeliWindow = Ext.extend(Ext.Window, {
	...
	constructor : function(config) {
		...
		uft.te.DeliWindow.superclass.constructor.call(this, {
			title : this.title||'提货',
			width : 850,
			height : 450,
			collapsible : false,
	...
	confirmArrival : function (){
		...
		uft.Utils.doAjax({
			scope : this,
			params : params,
			url : ctxPath + '/te/tracking/delivery.json',
