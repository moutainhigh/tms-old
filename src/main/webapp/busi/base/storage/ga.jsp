...
<html>
	...
	<script type="text/javascript">
		...
		function afterEditHead(field,value,originalValue){
			var length = uft.Utils.getNumberFieldValue('length');
			var width = uft.Utils.getNumberFieldValue('width');
			var height = uft.Utils.getNumberFieldValue('height');
			if(field.id == 'length'){
				Ext.getCmp('volume').setValue(length*width*height);
			}else if(field.id == 'width'){
				Ext.getCmp('volume').setValue(length*width*height);
