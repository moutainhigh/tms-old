...
<html>
	...
	<script type="text/javascript">
		...
		*/
		...
		//当编辑数量和价格时计算总价值
		function afterEditQuantityOrPrice(record){
			var quantity = uft.Utils.getNumberColumnValue(record,"quantity");
			var price = uft.Utils.getNumberColumnValue(record,"price");
			uft.Utils.setColumnValue(record,'amount',quantity*price);
		}
	</script>
