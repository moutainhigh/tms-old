...
function go() {
	...
	location.href="<%=request.getContextPath()%>/rf/sc/arriOrLeav.json?lot="+lot+"&type="+type;
	return false;
}
...
<body>
	...
	<tr id = "header" bgcolor="#009FCC">
		...
		<tr bgcolor="#009FCC">
		<td align="center" colspan="2">
			<font >	批次号：</font><input type="text" name="lot" id="lot" onkeydown="keyDown(event)">
			<!-- 设置隐藏域传递页面信息，避免重复代码 -->
			<input type="hidden" name="type" id="type" value="ar">
		</td >
		</tr>
		<tr bgcolor="#009FCC">
			<td align="center">
