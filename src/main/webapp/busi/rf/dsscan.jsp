...
<body >
	...
	<tr  align="center" bgcolor="#009FCC">
		<td colspan="2"> <a href="<%=request.getContextPath()%>/busi/rf/dsshow.jsp">返回</a>  </td>
		<td colspan="2"> <a id="saveBttn" href="<%=request.getContextPath()%>/rf/sc/deliScanConfirm.json" onclick="return checkBarcodes();">完成</a></td>
	</tr>
	</table>
</body>
</html>