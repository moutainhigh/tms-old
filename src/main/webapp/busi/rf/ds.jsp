...
<table id="main" border="3" bordercolor="FFFFFF">  
		...
		<tr bgcolor="#009FCC">
			<td align="center" colspan="2">
				...
				<!-- 设置隐藏域传递页面信息，避免重复代码 -->
				<input type="hidden" name="page" id="page" value="dsshow.jsp">
				<input type="hidden" name="nowPage" id="nowPage" value="ds.jsp">
				<input type="hidden" name="operate_type" id="operate_type" value="1">
			</td >
		</tr>
